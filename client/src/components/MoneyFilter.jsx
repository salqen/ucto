...
export default function MoneyFilter({ value, onApply, onClose, cats = { P: [], V: [] }, partners = [] }) {
  ...
  return (
    <div style={{ border: '1px solid var(--border)', borderRadius: 12, padding: 18, background: 'var(--panel)', color: 'var(--text)', boxShadow: 'var(--shadow)', maxWidth: 660 }}>
      ...
      <Field label="Partner" full>
        <input style={inp} list="mf-partners" value={f.partner} placeholder="názov partnera" onChange={e => set('partner', e.target.value)} />
        <datalist id="mf-partners">
