...
const FIRM_KEY = 'ucto_firm';
export const getFirm = () => localStorage.getItem(FIRM_KEY) || '';
export const setFirm = (id) => id ? localStorage.setItem(FIRM_KEY, String(id)) : localStorage.removeItem(FIRM_KEY);
